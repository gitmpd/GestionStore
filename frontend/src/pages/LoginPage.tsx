  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (account) {
        ...
        await logAction({ action: 'connexion', entity: 'utilisateur', entityName: account.name, details: 'Connexion hors-ligne' });
        navigate('/');
      } else {
        setError('Serveur inaccessible. Comptes hors-ligne :\n• Gérant : admin@store.com / admin123\n• Vendeur : vendeur@store.com / vendeur123');
      }
    } finally {
      setLoading(false);
    }
